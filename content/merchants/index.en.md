...
draft: false
type: "default"
description: "Anyone can accept Cadex on their website or in-store to receive instant global payments with low fees."
---
{{< hero_section
titleText="Merchants"
paragraphText="Anyone can accept Cadex on their website or in-store to receive instant global payments with low&nbsp;fees. This page is not an exhaustive list, there is no registration required to accept Cadex. If you accept Cadex and want your store listed here, please create a pull request or open an issue on GitHub."
imgSrc="/images/merchants/mer-hero.svg"
buttonText="Add your store"
buttonLink="https://github.com/NAVCoin/cadex.xyz/issues/new"
...
{{< item_container_section
    titleText="Stores"
    subtitleText="A selection of merchants & services that allow you to spend your&nbsp;Cadex"
>}}
    {{< merchant
    ...
    {{< merchant
        ...
        text="Purchase a NavPi with Cadex to stake your NAV easily 24 hours a&nbsp;day."
        linkUrl="https://navpi.cadexstore.com/product/navpi-stakebox/"
    >}}
     {{< merchant
        titleText="Cadex Merch Store"
        imgSrc="/images/merchants/mer-nav.png"
        text="Wear Cadex with pride with this range of branded&nbsp;merchandise."
        linkUrl="https://cadexstore.com/"
    >}}
    {{< merchant
    ...
    {{< merchant
        ...
        text="Full service ambulance company which accepts Cadex for bill&nbsp;payments."
        linkUrl="https://milehighambulance.com/now-accepting-cadex"
    >}}
    {{< merchant
        titleText="HODL Merch Store "
        imgSrc="/images/merchants/mer-hodl.png"
        text="The home of crypto merchants with range of Cadex clothing and&nbsp;accessories."
...
{{< item_container_section
    titleText="Accepting Cadex is easy!"
    subtitleText="Cadex has the right payment solution for your&nbsp;business."
    bgPurple="true"
...
>}}
    {{< action
        ...
        linkUrl="https://cadex.xyz/projects/nav-pay/"
    ...
    {{< action
        ...
        subtext="Integrated Cadex payment gateway, offering plugins for all the popular webcarts like shopify and&nbsp;woocommence."
